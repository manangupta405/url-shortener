...
func TestURLRepositoryPostgresqlImpl_GetShortURL_NoRowsError(t *testing.T) {
	...
	mock.ExpectQuery("SELECT short_path, original_url, expiry, created_at, created_by, modified_at, modified_by, deleted_at, deleted_by FROM urls WHERE original_url = ?").WithArgs(originalURL).WillReturnError(sql.ErrNoRows)
...
func TestURLRepositoryPostgresqlImpl_GetOriginalURL_NoRowsError(t *testing.T) {
	...
	mock.ExpectQuery("SELECT short_path, original_url, expiry, created_at, created_by, modified_at, modified_by, deleted_at, deleted_by FROM urls WHERE short_path = ?").WithArgs(shortPath).WillReturnError(sql.ErrNoRows)
